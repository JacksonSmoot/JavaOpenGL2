...
public final class AudioPlayer {
    ...
    private static final FFPacket NULL_PACKET = new FFPacket(null);
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    GLBufferedTexture albumArt = new GLBufferedTexture(w, h);

                    albumArt.upload(rgba);
                    albumArt.send();

                    return albumArt.asGLImage();
